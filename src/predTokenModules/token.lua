...
local Token = {}
local TokenMethods = {}
local TokenNotices = require('ocmTokenModules.tokenNotices')
...
function TokenMethods:mint(to, quantity, cast, msg)
  ...
  -- Send notice
  if not cast then return self.mintNotice(to, quantity, msg) end
end
