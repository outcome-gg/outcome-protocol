...
describe("#market #semiFungibleTokens #semiFungibleTokensValidation", function()
  ...
  it("should pass balance validation", function()
    local success, err = semiFungibleTokensValidation.balance(msgBalance, positionIds)
    assert.is_true(success)
    assert.is_nil(err)
  end)

  it("should fail balance validation when positionId is invalid", function()
